...
async function askQuestion(){
    ...
    switch(answer.operator){
        case "+ Addition": {
            console.log(chalk.blue(`${answer.num1} + ${answer.num2} = ${add(answer.num1, answer.num2)}`));
            break;
        }
        case "- Subtraction": {
            console.log(chalk.blue(`${answer.num1} - ${answer.num2} = ${sub(answer.num1, answer.num2)}`));
            break;
        }
        case "* Multiplication": {
            console.log(chalk.blue(`${answer.num1} x ${answer.num2} = ${mul(answer.num1, answer.num2)}`));
            break;
        }
        case "/ Division": {
            console.log(chalk.blue(`${answer.num1} / ${answer.num2} = ${div(answer.num1, answer.num2)}`));
            break;
        }
        default: {
